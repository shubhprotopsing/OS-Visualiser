...
function signup()
{
 ...
 var label2 = document.createTextNode('1. Garvit')
 var label3 = document.createTextNode('2. Dhiren')
 var label4 = document.createTextNode('3. Mehul')
 var label5 = document.createTextNode('4. Daksh')
